  ...
  },
  {
    ...
    items: [
      { id: "infra", label: "Overview", icon: "fa-server", to: "/infra" },
      {
        ...
        to: "/infra/assets",
        matchPrefix: "/infra/assets",
        badge: { n: 1599, kind: "neutral" },
      },
      {
        id: "infra-topology",
