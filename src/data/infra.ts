...
export const DEVICES: readonly Device[] = [
  ...
  // Hypervisors + physical servers
  {
    ...
    mem: 78,
    status: "warn",
    role: "vSphere host · 28 VMs",
    iface: "—",
    throughput: "—",
    sessions: "—",
    lastSeen: "1s ago",
    agent: "vmware-exporter",
  },
  {
    id: "ESX-BLR-02",
    kind: "hypervisor",
  ...
  },
  {
    ...
    mem: 88,
    status: "warn",
    role: "SQL Server · prod",
    iface: "—",
    throughput: "—",
    sessions: "—",
    lastSeen: "0s",
    agent: "win-exporter+mssql",
  },
  {
    id: "WIN-FILE-01",
    kind: "win-srv",
    model: "VM · 4 vCPU · 16 GB",
    site: "dc-fra-1",
    ip: "10.20.30.40",
    os: "Windows Server 2019",
    uptime: "184d 9h",
  ...
  // Storage
  {
    ...
    mem: 58,
    status: "ok",
    role: "Block · 187 TB used / 280 TB",
    iface: "—",
    throughput: "4.2 GB/s",
    sessions: "—",
    lastSeen: "2s ago",
    agent: "purity-exporter",
  },
  {
    id: "NAS-BLR-01",
    kind: "storage",
  ...
  // UPS
  {
    ...
    mem: 0,
    status: "ok",
    role: "Row A · 142 kW load · 87% load",
    iface: "—",
    throughput: "—",
    sessions: "—",
    lastSeen: "10s ago",
  ...
  },
  {
    ...
    mem: 0,
    status: "warn",
    role: "Row B · 138 kW load · 86% load",
    iface: "—",
    throughput: "—",
    sessions: "—",
    lastSeen: "10s ago",
...
export const INFRA_ALERTS: readonly InfraAlert[] = [
  {
    id: "INF-A-2241",
    sev: "critical",
    device: "SW-BLR-TOR-13",
    site: "dc-blr-1",
    title: "Switch fan-tray failure detected",
    detail: "Fan 3 RPM 0 · ambient temp 48°C",
    since: "8m ago",
    rule: "snmp.fan.failure",
  },
  {
    id: "INF-A-2240",
    sev: "critical",
    device: "LNX-K8S-W-05",
    site: "dc-blr-1",
    title: "Host unreachable · last seen 4m ago",
    detail: "ICMP + node-exporter scrape both failing",
    since: "4m ago",
    rule: "host.down",
  },
  {
    id: "INF-A-2239",
    sev: "warn",
    device: "FW-BLR-DMZ-02",
    site: "dc-blr-1",
    title: "CPU sustained > 70% for 15m",
    detail: "Current 71% · 15m avg 73%",
    since: "22m ago",
    rule: "fw.cpu.high",
  },
  {
    id: "INF-A-2238",
    sev: "warn",
    device: "WIN-SQL-PROD-01",
    site: "dc-blr-1",
    title: "Memory pressure 88%",
    detail: "Buffer cache hit ratio 96.4% · page life 142s",
    since: "38m ago",
    rule: "win.mem.high",
  },
  {
    ...
    device: "ESX-BLR-01",
    site: "dc-blr-1",
    title: "Datastore latency > 25ms",
    detail: "vmfs-prod-01 · avg 28ms · p99 64ms",
    since: "1h ago",
    rule: "vmware.ds.latency",
  },
  {
    id: "INF-A-2236",
    sev: "warn",
    device: "UPS-BLR-B",
    site: "dc-blr-1",
    title: "Battery runtime estimate < 12 min",
    detail: "Current load 86% · runtime 11m 42s",
    since: "2h ago",
    rule: "ups.runtime.low",
  },
  {
    id: "INF-A-2235",
    sev: "warn",
    device: "EXP-FRA-VSPHERE",
    site: "dc-fra-1",
    title: "Exporter scrape lag 38s",
    detail: "Stale targets: 12 · last successful 38s ago",
    since: "9m ago",
    rule: "exporter.lag",
  },
  {
    id: "INF-A-2234",
    sev: "info",
    device: "FW-BLR-CORE-01",
    site: "dc-blr-1",
    title: "BGP session flap (recovered)",
    detail: "Peer 172.16.0.4 · down 2s, recovered",
    since: "1h ago",
    rule: "bgp.flap",
  },
];
...
export const EXPORTERS: readonly Exporter[] = [
  {
    ...
    lag: "0.4s",
    status: "ok",
    sites: ["dc-blr-1", "dc-fra-1", "dc-nyc-1"],
  },
  {
